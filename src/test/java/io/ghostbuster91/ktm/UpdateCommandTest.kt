...
class UpdateCommandTest {
    ...
    fun `should update installed library to newer version`() {
        ...
        val binaryFile = File(testFolderRuler.root.absolutePath, ".ktm/modules/testOrg/validRepo/1.2.0/sample-bin")
        ...
        assertEquals("1.2.0", value.toList().dropLast(1).last().toString())
    }
}